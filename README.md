...
### Personnal
At time of writing, my personnal situation is such that i hadn't touched a terminal in years. Recently having repaired my old laptop, i've been playing with configurating it and doing it right.
This project is part of my larger hobby of seting up a fully custom i3bar for i3 cause i3's DA BEST.

Thus, I'm using this custom pomodoro project to reacquaint myself with good practices in python, git, sys admin, packaging...
